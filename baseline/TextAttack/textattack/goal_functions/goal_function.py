...
class GoalFunction(ReprMixin, ABC):
    ...
    def init_attack_example(self, attacked_text, ground_truth_output,target_class=None):
        ...
        self.num_queries = 0
        result, _ = self.get_result(attacked_text, check_skip=False) #TODO, changed, we don't need check_skip because in our code we have already checked!
        return result, _
